...
1. Clone the repository:
   ```sh
   git clone https://github.com/maedeshabani/Adaption-for-BERT.git
   cd Adaption-for-BERT
2. Run the Jupyter Notebook bert_adaptation.ipynb to train and evaluate models.
